...
enum opt_code
{
  ...
  OPT_nostdlib__ = 1472,                     /* -nostdlib++ */
  OPT_o = 1473,                              /* -o */
  OPT_p = 1474,                              /* -p */
  OPT_pass_exit_codes = 1475,                /* -pass-exit-codes */
  /* OPT_pedantic = 1476, */                 /* -pedantic */
  OPT_pedantic_errors = 1477,                /* -pedantic-errors */
  OPT_pg = 1478,                             /* -pg */
  OPT_pie = 1479,                            /* -pie */
  OPT_pipe = 1480,                           /* -pipe */
  OPT_posix = 1481,                          /* -posix */
  OPT_print_file_name_ = 1482,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1483,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1484,          /* -print-multi-directory */
  OPT_print_multi_lib = 1485,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1486,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1487,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1488,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1489,               /* -print-prog-name= */
  OPT_print_search_dirs = 1490,              /* -print-search-dirs */
  OPT_print_sysroot = 1491,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1492,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1493,                        /* -profile */
  OPT_pthread = 1494,                        /* -pthread */
  OPT_quiet = 1495,                          /* -quiet */
  OPT_r = 1496,                              /* -r */
  OPT_rdynamic = 1497,                       /* -rdynamic */
  OPT_remap = 1498,                          /* -remap */
  OPT_s = 1499,                              /* -s */
  OPT_save_temps = 1500,                     /* -save-temps */
  OPT_save_temps_ = 1501,                    /* -save-temps= */
  OPT_shared = 1502,                         /* -shared */
  OPT_shared_libgcc = 1503,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1504,               /* -shared-libphobos */
  /* OPT_specs = 1505, */                    /* -specs */
  OPT_specs_ = 1506,                         /* -specs= */
  OPT_static = 1507,                         /* -static */
  OPT_static_libasan = 1508,                 /* -static-libasan */
  OPT_static_libgcc = 1509,                  /* -static-libgcc */
  OPT_static_libgfortran = 1510,             /* -static-libgfortran */
  OPT_static_libgo = 1511,                   /* -static-libgo */
  OPT_static_liblsan = 1512,                 /* -static-liblsan */
  OPT_static_libmpx = 1513,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1514,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1515,               /* -static-libphobos */
  OPT_static_libstdc__ = 1516,               /* -static-libstdc++ */
  OPT_static_libtsan = 1517,                 /* -static-libtsan */
  OPT_static_libubsan = 1518,                /* -static-libubsan */
  OPT_static_pie = 1519,                     /* -static-pie */
  /* OPT_std_c__03 = 1520, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1521, */                /* -std=c++0x */
  OPT_std_c__11 = 1522,                      /* -std=c++11 */
  OPT_std_c__14 = 1523,                      /* -std=c++14 */
  OPT_std_c__17 = 1524,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1525, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1526, */                /* -std=c++1z */
  OPT_std_c__2a = 1527,                      /* -std=c++2a */
  OPT_std_c__98 = 1528,                      /* -std=c++98 */
  OPT_std_c11 = 1529,                        /* -std=c11 */
  OPT_std_c17 = 1530,                        /* -std=c17 */
  /* OPT_std_c18 = 1531, */                  /* -std=c18 */
  /* OPT_std_c1x = 1532, */                  /* -std=c1x */
  OPT_std_c2x = 1533,                        /* -std=c2x */
  /* OPT_std_c89 = 1534, */                  /* -std=c89 */
  OPT_std_c90 = 1535,                        /* -std=c90 */
  OPT_std_c99 = 1536,                        /* -std=c99 */
  /* OPT_std_c9x = 1537, */                  /* -std=c9x */
  OPT_std_f2003 = 1538,                      /* -std=f2003 */
  OPT_std_f2008 = 1539,                      /* -std=f2008 */
  OPT_std_f2008ts = 1540,                    /* -std=f2008ts */
  OPT_std_f2018 = 1541,                      /* -std=f2018 */
  OPT_std_f95 = 1542,                        /* -std=f95 */
  OPT_std_gnu = 1543,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1544, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1545, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1546,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1547,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1548,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1549, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1550, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1551,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1552,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1553,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1554,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1555, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1556, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1557,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1558, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1559,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1560,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1561, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1562, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1563,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1564, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1565, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1566, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1567, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1568, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1569,                     /* -std=legacy */
  OPT_symbolic = 1570,                       /* -symbolic */
  OPT_t = 1571,                              /* -t */
  OPT_time = 1572,                           /* -time */
  OPT_time_ = 1573,                          /* -time= */
  OPT_tno_android_cc = 1574,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1575,                 /* -tno-android-ld */
  OPT_traditional = 1576,                    /* -traditional */
  OPT_traditional_cpp = 1577,                /* -traditional-cpp */
  OPT_trigraphs = 1578,                      /* -trigraphs */
  OPT_u = 1579,                              /* -u */
  OPT_undef = 1580,                          /* -undef */
  OPT_v = 1581,                              /* -v */
  OPT_version = 1582,                        /* -version */
  OPT_w = 1583,                              /* -w */
  OPT_wrapper = 1584,                        /* -wrapper */
  OPT_x = 1585,                              /* -x */
  OPT_z = 1586,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
